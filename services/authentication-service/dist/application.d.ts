...
declare const AuthenticationServiceApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class AuthenticationServiceApplication extends AuthenticationServiceApplication_base {
    localeObj: i18nAPI;
